...
// namespace Eddie
// {
// 	public static class ShortCircuitOld
// 	{
...
// 				yield return new CodeInstruction(OpCodes.Ldarg_0);
// 				yield return new CodeInstruction(OpCodes.Call, typeof(ShortCircuit).GetMethod("GetActionsAgain", BindingFlags.Static | BindingFlags.NonPublic));
...
// 		private static List<CardAction> GetActionsAgain(Card card, State s, Combat c) {
// 			return new List<CardAction> {
// 				new QueueCardActions {
// 					selectedCard = card
// 				}
// 			};
// 		}
